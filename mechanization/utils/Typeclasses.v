...
(* LATER: The cost (10) was needed at some point to avoid stack overflows when resolving EqDec in some theorems (e.g. EarlyErrors.groupSpecifiersThatMatch_singleton). *)
